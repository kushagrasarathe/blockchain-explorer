...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-neutral-700 transition-colors hover:bg-none data-[state=selected]:bg-neutral-100 dark:hover:bg-none dark:data-[state=selected]:bg-neutral-800",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2.5 align-middle text-sm [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
